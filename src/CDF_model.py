...
class CDF(object):
    ...
    def save_model(self, epoch, stats, first=False):
        ...
        current_model_filename = f'UHDFour-epoch{epoch + 1}-{current_psnr:.5f}.pt'
    ...
    def eval(self, valid_loader):
        ...
        for batch_idx, (source, target1,degrad_name) in enumerate(valid_loader):
    ...
    def train(self, train_loader, valid_loader):  
        ...
        for epoch in range(self.p.nb_epochs):
            ...
            for batch_idx, (source, target) in enumerate(train_loader):
                ...
                loss_ssimdown = 0.0002*0.15*(1-pytorch_ssim.ssim(final_result_down, F.interpolate(target,scale_factor=scale,mode='bilinear')))
                loss_final = loss_l1+loss_ssim+loss_per+loss_l1down+loss_ssimdown
